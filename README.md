...
> with the values of the passwords defined in the [`.env`](.env) file (_"risetELK"_ by default). The first one is the
...
The _"risetELK"_ password set by default for all aforementioned users is **unsecure**. For increased security, we will
